...
vim.keymap.set('n', '<D-b>', telescope_builtin.buffers, { desc = '[F]ind [B]uffers' })
...
-- vim.keymap.set('n', '<leader>fe', require('telescope.builtin').find_files({cwd = "~/.config"}), { desc = '[F]ind files in [C]onfig' })
